...
void __interrupt(low_priority) myLoIsr(void){
    ...
    INTCONbits.TMR0IF = 0;
    TMR0L = 0b11011011; //Parte baja del tmr0 de 62500 (1 seg con ps de 128)
    TMR0H = 0b1011;
    }
}
...
void main(void) {
    ...
    INTCONbits.INT0IE = 1; //Habilita la interrupcion externa 0
    INTCONbits.INT0IF = 0; //Establece flag en 0 (ext))
    ...
    INTCON2bits.TMR0IP = 0; //Prioridad baja para int del tmr
    ...
    T0CONbits.T0PS = 0b110; //Prescaler a 128
//    T0CONbits.T0PS = 0b101; //Prescaler a 64
    TMR0L = 0b11011011; //Parte baja del tmr0 de 62500 (1 seg con ps de 128)
    TMR0H = 0b1011; //Parte alta del tmr0 de 62500 (1 seg con ps de 128)
//    TMR0L = 0b01111100; //Parte baja del tmr0 de 37500 (300ms seg con ps de 64)
//    TMR0H = 0b10010010; //Parte alta del tmr0 de 37500 (300ms seg con ps de 64)
    ANSELA = 0;
    TRISA=0;
    PORTA=0;
    ANSELB = 0;
