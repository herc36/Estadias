 ...
 * Author: chiky
 *
 * Created on 29 de septiembre de 2020, 03:21 PM
 */
...
void __interrupt() myIsr(void){
    if (INTCONbits.TMR0IF==1){
        ...
        INTCONbits.TMR0IF = 0;
        TMR0L = 0b11011100; //Parte baja del tmr0 de 3036 [65536-62500] (500ms seg con ps de 128)
        TMR0H = 0b1011; //Parte alta del tmr0 de 3036 [65536-62500] (500ms seg con ps de 128)
